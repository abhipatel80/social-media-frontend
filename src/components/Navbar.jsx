        ...
        <>
            <nav className='shadow-md bg-white fixed top-0 w-full'>
                <ul className='flex p-3'>
                    <NavLink to="/">
                        <h2 className='md:text-2xl text-xl ml-4 cursor-pointer mr-4 mb-1'>Interwave</h2>
                    </NavLink>
                            ...
                            {({
                                ...
                                >
                                    {searchUsers?.length <= 0 ?
                                        ...
                                        <>
                                            {searchUsers && searchUsers?.map((val) => {
                                                return (
                                                    <>
                                                        <NavLink to={`/profile/${val._id}`} key={val._id} onClick={() => setShow(false)}>
